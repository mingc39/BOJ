...
int main() {
	...
	if(a > 0 && b > 0 || a < 0 && b < 0) putchar('0'); // 선분2가 직선1의 한쪽에 있는 경우
		...
		if(l1.x1 == l1.x2 && l1.x2 == l2.x1 && l2.x1 == l2.x2) { // y축 평행 
			if(l1.y1 > l2.y1 && l1.y1 > l2.y2 && l1.y2 > l2.y1 && l1.y2 > l2.y2) putchar('0');
			else if(l2.y1 > l1.y1 && l2.y1 > l1.y2 && l2.y2 > l1.y1 && l2.y2 > l1.y2) putchar('0');
			else putchar('1');
		} else { // x축 평행, 대각선  
			if(l1.x1 > l2.x1 && l1.x1 > l2.x2 && l1.x2 > l2.x1 && l1.x2 > l2.x2) putchar('0');
			else if(l2.x1 > l1.x1 && l2.x1 > l1.x2 && l2.x2 > l1.x1 && l2.x2 > l1.x2) putchar('0');
			else putchar('1');
		}
	} else putchar('1');
